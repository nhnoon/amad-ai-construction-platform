...
export type SiteReportAnalysis = {
  ...
  reasoning_status: string; // "completed" | "unavailable"
  ...
  return (
    <div className="rounded-xl border border-amber-500/30 bg-amber-500/[0.06] p-4">
      <div className="flex items-center gap-2">
        ...
        <p className="text-sm font-semibold text-amber-700 dark:text-amber-400">AI reasoning unavailable</p>
      </div>
...
export default function SiteReportAnalysisPanel({ data }: { data: SiteReportAnalysis }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Section title="Major Findings" icon={ListChecks}>
        <BulletList items={data.major_findings} />
      </Section>
      ...
      <Section title="Schedule Findings" icon={CheckCircle2}>
        <BulletList items={data.schedule_findings} />
      </Section>

      <Section title="Procurement Findings" icon={Package}>
        <BulletList items={data.procurement_findings} />
      </Section>

      <Section title="Equipment Issues" icon={Wrench}>
        <BulletList items={data.equipment_issues} />
      </Section>
      ...
      <Section title="Blocked Activities" icon={AlertTriangle}>
        <BulletList items={data.blocked_activities} />
      </Section>

      <Section title="Critical Risks" icon={Radar}>
        <BulletList items={data.critical_risks} />
      </Section>

      {data.contradictions.length > 0 && (
        <Section title="Contradictions Found in Evidence" icon={Siren}>
      ...
      <Section title="Next Site Visit Focus" icon={Target}>
        <BulletList items={data.next_site_visit_focus} />
      </Section>

      <Section title="Questions for Site Team" icon={HelpCircle}>
        <BulletList items={data.questions_for_site_team} />
      </Section>
