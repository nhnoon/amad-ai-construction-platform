...
const en: Record<string, string> = {
  ...
  "e.g. Weekly Progress Sync": "e.g. Weekly Progress Sync",
  "Comma-separated names": "Comma-separated names",
  "Back to Meetings": "Back to Meetings",
  "Meeting not found": "Meeting not found",
  "Failed to load meetings": "Failed to load meetings",
  "Failed to load decisions": "Failed to load decisions",
  "Due": "Due",
  "Sources": "Sources",
  "Summarize this meeting": "Summarize this meeting",
  'Click "Summarize this meeting" to get an AI-generated summary of this meeting only.':
    'Click "Summarize this meeting" to get an AI-generated summary of this meeting only.',
  ...
  "Grounded AMAD Analysis": "Grounded AMAD Analysis",
...
const ar: Record<string, string> = {
  ...
  "Open Action Items": "بنود العمل المفتوحة",
  ...
  "e.g. Weekly Progress Sync": "مثال: اجتماع المتابعة الأسبوعي",
  "Comma-separated names": "أسماء مفصولة بفواصل",
  "Back to Meetings": "العودة إلى الاجتماعات",
  "Meeting not found": "الاجتماع غير موجود",
  "Failed to load meetings": "فشل تحميل الاجتماعات",
  "Failed to load decisions": "فشل تحميل القرارات",
  "Due": "الموعد النهائي",
  "Sources": "المصادر",
  "Summarize this meeting": "لخص هذا الاجتماع",
  'Click "Summarize this meeting" to get an AI-generated summary of this meeting only.':
    'اضغط على "لخص هذا الاجتماع" للحصول على ملخص بالذكاء الاصطناعي لهذا الاجتماع فقط.',
  ...
  "Grounded AMAD Analysis": "تحليل آماد الموثّق بالأدلة",
