#!/usr/bin/env python
"""
Migrate SQLite dataset to PostgreSQL - Custom path version.
...
# Updated path for local backend/data/ location
SQL_DUMP = os.path.join(
    os.path.dirname(__file__),
    "data/construction_ai_dataset_full_dump.sql",
)
...
def run():
    ...
    # First, clear all data from tables (truncate in reverse dependency order)
